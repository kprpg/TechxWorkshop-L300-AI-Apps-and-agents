...
Select the **+ New connection** button again and this time choose the **Azure AI Search** option from the list.

![Add connection for the Azure AI Search resource.](../../media/Solution/0102_ConnectResources7.png)

Then, navigate to the Azure AI Search resource that you created in the first task. From the **Authentication** menu, select **Microsoft Entra ID** to ensure that you use the system-assigned managed identity. Then, select the **Add connection** button associated with this Azure AI Search resource to make the connection. When you are done, select **Close** to close this modal dialog.

![Add connection for the Azure AI Search resource.](../../media/Solution/0102_ConnectResources8.png)
...
{: .note }
> The .env file also includes placeholders for agent IDs. You will fill these in later in the training when you create the agents.
